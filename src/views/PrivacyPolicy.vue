        ...
        <div class="prose prose-lg max-w-none">
          ...
          <section class="mb-8">
            ...
            <p class="text-gray-700 mb-4">
              O3 TT Gifts ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our TikTok live stream analytics platform and related services (collectively, the "Service").
            </p>
            <p class="text-gray-700 mb-4">
          ...
          <section class="mb-8">
            ...
            <h3 class="text-xl font-semibold text-gray-900 mb-3">2.2 TikTok Data</h3>
            <p class="text-gray-700 mb-4">With your explicit consent, we collect:</p>
            <ul class="list-disc pl-6 text-gray-700 mb-4">
              <li>TikTok account information and live stream data</li>
              <li>Gift transaction data and analytics</li>
              <li>Viewer engagement metrics</li>
              <li>Chat interaction data</li>
              <li>Stream performance statistics</li>
            </ul>
          ...
          <section class="mb-8">
            ...
            <p class="text-gray-700 mb-4">Depending on your jurisdiction, you may have the following rights:</p>
            <ul class="list-disc pl-6 text-gray-700 mb-4">
            ...
            <p class="text-gray-700 mb-4">
              To exercise these rights, please contact us at <a href="mailto:support@o3-ttgifts.com" class="text-primary-600 hover:underline">support@o3-ttgifts.com</a>.
            </p>
          </section>
          ...
          <section class="mb-8">
            ...
            <p class="text-gray-700 mb-4">
              We use cookies and similar tracking technologies to enhance your experience on our Service. For detailed information about our use of cookies, please refer to our <router-link to="/cookie-policy" class="text-primary-600 hover:underline">Cookie Policy</router-link>.
            </p>
          </section>
